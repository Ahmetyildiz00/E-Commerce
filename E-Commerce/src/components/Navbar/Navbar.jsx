    ...
    return (
        <div className="navbar" >
            ...
            <ul className="nav-menu">
                ...
                <li onClick={() => { setMenu("men") }}><Link style={{ color: "white", textDecoration: "none" }} to="/men">Men</Link>{menu === "men" ? <hr /> : <></>}</li>
                <li onClick={() => { setMenu("women") }}><Link style={{ color: "white", textDecoration: "none" }} to="/women">Women</Link>{menu === "women" ? <hr /> : <></>}</li>
                <li onClick={() => { setMenu("kid") }}><Link style={{ color: "white", textDecoration: "none" }} to="/kid">Kids</Link>{menu === "kid" ? <hr /> : <></>}</li>
            </ul>
